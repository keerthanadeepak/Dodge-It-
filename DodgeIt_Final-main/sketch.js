...
welcomeimage.scale=1; 
welcomeimage.visible =false;
  
shell = createSprite(width/2,height-160,200,200);
shell.addImage(shellImg);
shell.scale=0.8; 
shell.visible =false; 

playbutton = createSprite(width/2,height-170,200,200);
playbutton.addImage(playbuttonimg);
playbutton.scale=0.5; 
playbutton.visible =false;  
  
one = createSprite(155,height-200,195,200);
one.addImage(oneImg);
one.scale=1; 
one.visible =false;  
  
two = createSprite(width-100,height-200,200,200);
two.addImage(twoImg);
two.scale=1.1; 
two.visible =false;  
...
bubbles = createSprite(width/2.65,height/2.3,200,200);
...
levelsboard.scale=0.6; 
levelsboard.visible =false;  
  
level1 = createSprite(width/2.8,height/3.5,200,200);
level1.addImage(level1Img);
level1.scale=0.5; 
level1.visible =false;  

level2 = createSprite(width/2.01,height/3.5,200,200);
level2.addImage(level2Img);
level2.scale=0.5; 
level2.visible =false;   

level3 = createSprite(width/2+270,height/3.5,200,200);
level3.addImage(level3Img);
level3.scale=0.5; 
level3.visible =false;
  
level4 = createSprite(width/2.8,height/1.55,200,200);
level4.addImage(level4Img);
level4.scale=0.5; 
level4.visible =false;  

level5 = createSprite(width/2.01,height/1.55,200,200);
level5.addImage(level5Img);
level5.scale=0.5; 
level5.visible =false; 
  
level6 = createSprite(width/2+270,height/1.55,200,200);
...
claim1 = createSprite(width/2.8,height/2.6,200,200);
claim1.addImage(claimbuttonImg);
claim1.scale=0.14; 
claim1.visible =false;   
    
claim2 = createSprite(width/2.01,height/2.7,200,200);
claim2.addImage(claimbuttonImg);
claim2.scale=0.14; 
claim2.visible =false; 

claim3 = createSprite(width/2+270,height/2.6,200,200);
claim3.addImage(claimbuttonImg);
claim3.scale=0.14; 
claim3.visible =false; 

claim4 = createSprite(width/2.8,height/1.35,200,200);
claim4.addImage(claimbuttonImg);
claim4.scale=0.14; 
claim4.visible =false;   
    
claim5 = createSprite(width/2.01,height/1.35,200,200);
claim5.addImage(claimbuttonImg);
claim5.scale=0.14; 
claim5.visible =false; 

claim6 = createSprite(width/2+70,height/1.35,200,200);
...
function draw() {
  fish.setCollider("circle", 2, 3, 'radius')
  fish.debug=false;
